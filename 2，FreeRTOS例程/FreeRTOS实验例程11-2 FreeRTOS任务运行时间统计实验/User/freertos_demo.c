...
void task1(void *pvParameters)
{
    ...
    while (1)
    {
        lcd_fill(6, 131, 114, 313, lcd_discolor[++task1_num % 11]);             /* LCD区域刷新 */
        lcd_show_xnum(71, 111, task1_num, 3, 16, 0x80, BLUE);                   /* 显示任务1运行次数 */
...
void task2(void *pvParameters)
{
    ...
    while (1)
    {
        lcd_fill(126, 131, 233, 313, lcd_discolor[11 - (++task2_num % 11)]);    /* LCD区域刷新 */
        lcd_show_xnum(191, 111, task2_num, 3, 16, 0x80, BLUE);                  /* 显示任务2运行次数 */
