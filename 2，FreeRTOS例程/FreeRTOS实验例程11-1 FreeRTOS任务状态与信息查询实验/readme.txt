 ...
 ***************************************************************************************************
 * 实验简介
 * 实验名称：FreeRTOS 任务状态与信息查询实验
 * 实验平台：正点原子 精英F103开发板
 * 实验目的：学习 FreeRTOS 任务状态与信息查询
 ...
 * 实验现象
 * 1 TFTLCD模块显示本实验相关信息。
 * 2 按下KEY0按键，分步执行函数uxTaskGetSystemState()的使用、函数vTaskGetInfo()的使用、
     函数eTaskGetState()的使用、函数vTaskList()的使用，并通过串口打印相关信息。
